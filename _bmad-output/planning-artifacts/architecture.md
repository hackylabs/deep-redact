...
- The runtime uses a two-lane execution strategy:
  ...
  - a generic iterative traversal lane for all other configurations: recursive wildcard (`**`) paths, regex path segments, key matching, substring rules, matcher objects, transformer handling, and hostile-shape recovery
