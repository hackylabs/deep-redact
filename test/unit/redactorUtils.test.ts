...
import type { ComplexStringTest, Transformer } from '../../src/types'
...
describe('RedactorUtils', () => {
  ...
  describe('createTransformedpaths', () => {
    describe('with a custom config', () => {
      ...
      describe('when the key is a ObjectPathConfig', () => {
        it('should create a transformed object path using key specific config and custom config fallback', () => {
          // @ts-expect-error - createTransformedpaths is private but we're testing it
          expect(utils.createTransformedObjectPath({
            path: ['a'],
            remove: false,
            replacement: '[REDACTED]',
            replaceStringByLength: false,
  ...
  describe('handlePrimitiveValue', () => {
    ...
    describe('when value is a string', () => {
      describe('when the value is a string', () => {
        ...
        describe('when the path is blacklisted', () => {
        ...
        describe('when the path is not blacklisted', () => {
          beforeEach(() => {
            // @ts-expect-error - handlePrimitiveValue is private but we're testing it
