...
import * as consoleAdapterSurface from '@hackylabs/deep-redact/adapters/console'
...
const resolvePrivateSubpath = async (subpath) => {
  try {
...
console.log(JSON.stringify({
  ...
  privateAdapterSubpathErrors: await Promise.all([
